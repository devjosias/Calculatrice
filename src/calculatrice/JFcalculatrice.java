 ...
 * @author Serach
 */
public class JFcalculatrice extends javax.swing.JFrame {

    /**
     * Creates new form JFcalculatrice
     */
    public JFcalculatrice() {
        initComponents();
    }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        String[] tab= this.ecran.getText().split("\\+");
        int somme=0;
        for (String tab1 : tab) {
            somme = Integer.parseInt(tab1) + somme;
        }
            this.ecran.setText(somme+"");
       /* String[] tab1= this.ecran.getText().split("\\-");
               double somme1=0;
               for(int i=0;i<tab1.length;i++)
        {
            somme1= Double.parseDouble(tab1[i])+somme;
        }
               
                this.ecran.setText(somme1+"");*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFcalculatrice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFcalculatrice().setVisible(true);
            }
        });
    }
